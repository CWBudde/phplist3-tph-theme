...
<script type="text/javascript" src="admin/ui/tph/js/jquery.min.js"></script>
<script type="text/javascript" src="admin/js/phplistapp.js"></script>
<script type="text/javascript" src="admin/ui/tph/js/dist/phpList_ui_bootlist.min.js"></script>
<script>
